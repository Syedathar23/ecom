...
async function createAdmin() {
  try {
    ...
    if (adminExists.rows.length === 0) {
      ...
      await query(
        `INSERT INTO users (firstname, lastname, email, password, role, isverified, createdat, updatedat) VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())`,
      ...
      console.log('ℹ️ Admin user already exists, role updated.');
    }
    process.exit(0);
  } catch (err) {
